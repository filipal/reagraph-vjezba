  ...
  return (
    <div className="use-of-data-page">
      ...
      <div className="content">
        ...
        <div className="section-title">Personal Data We Use</div>
        ...
        <div className="section-title">Why We Collect This Information</div>
        <p>
      ...
      <button className="back-button-useofdata" onClick={() => navigate('/avatar-info')}>Back</button>
    </div>
  )
}
