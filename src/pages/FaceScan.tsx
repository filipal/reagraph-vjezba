...
import FaceGuide from '../assets/face-guide.png'
    ...
    if (scanPhase === 'initial') {
      ...
      if (singleScan) {
        if (orientation === 'front') {
          ...
          navigate('/face-photos-check', { state: { frontImage: placeholder } })
        } else {
          navigate('/face-photos-check', { state: { sideImage: placeholder } })
        }
